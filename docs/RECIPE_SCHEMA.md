...
- Non-vegan ingredients (honey, egg, dairy, meat, fish, gelatin) disqualify the recipe. When the book offers a vegan variant, structure the vegan variant and say so in `diet.notes`.
